    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-start">
        ...
        <div className="w-full sm:w-auto">
          <motion.button
            onClick={() => setMacExpanded(!macExpanded)}
            className="download-btn group w-full"
          ...
          >
            ...
            <ChevronDown className={`w-4 h-4 text-muted-foreground transition-transform duration-200 ${macExpanded ? "rotate-180" : ""}`} />
          </motion.button>
            ...
            {macExpanded && (
              ...
              >
                <div className="flex flex-col gap-2 mt-2">
                  <motion.a
                    href="https://github.com/openclaw/openclaw/releases/latest/download/OpenClaw-macOS-arm64.dmg"
                    className="download-btn-sub group"
        ...
        <motion.a
          ...
          className="download-btn group w-full sm:w-auto"
          whileHover={{ scale: 1.03, boxShadow: "0 0 25px hsl(var(--primary) / 0.3)" }}
          whileTap={{ scale: 0.97 }}
        >
          <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
